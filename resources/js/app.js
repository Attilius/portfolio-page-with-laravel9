...
const portfolioHeight = document.getElementById('portfolio').clientHeight;
const heroSectionEndPoint = heroHeight;
const aboutSectionEndPoint = heroHeight + aboutHeight;
const portfolioSectionEndPoint = heroHeight + aboutHeight + portfolioHeight;
const selectLanguageDropDownBox = document.getElementById('language_drop_down_box');
const selectLanguageBtn = document.getElementById('lang_btn');
...
let action = false;
let languageSelectAction = false;
