    ...
    <div class="relative inline-block text-left lg:ml-6 xl:ml-12 bg-slate-200 text-gray-900 text-sm
        ...
        <div>
            <button id="lang_btn"
                ...
                <svg id="chevron_down" class="-mr-1 ml-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
    ...
    <div id="language_drop_down_box"
        ...
        <div class="py-1" role="none">
            ...
            <a onclick="{
               ...
               href="#" id="language-item-en" class="flex justify-center align-middle text-gray-700 block px-2 py-2 text-sm"
               role="menuitem" tabindex="-1">
                <x-flag-language-en class="w-8 h-8" /> <span id="lang_en" class="ml-2 pt-1 dark:text-white dark:hover:text-gray-400">English</span>
            </a>
            <a onclick="{
                const url = `{{ route('changeLang') }}`
               ...
               href="#" id="language-item-hu" class="flex justify-center align-middle text-gray-700 block px-2 py-2 text-sm"
               role="menuitem" tabindex="-1">
                <x-flag-language-hu class="w-8 h-8" /> <span id="lang_hu" class="ml-2 pt-1 dark:text-white dark:hover:text-gray-400">Magyar</span>
            </a>
        </div>
    </div>
</li>
