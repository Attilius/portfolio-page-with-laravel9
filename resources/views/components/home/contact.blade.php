      ...
      <div class="flex flex-wrap lg:justify-between -mx-4">
        <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
          <div class="max-w-[570px] mb-12 lg:mb-0">
            <h1 id="contact-head" class="text-dark dark:text-gray-100 mb-6 capitalize font-bold text-[32px] sm:text-[40px] lg:text-[36px] xl:text-[40px]">Contact<p id="contact-head" class="me text-GoldenRod-500 lowercase">me</p>
            </h1>
