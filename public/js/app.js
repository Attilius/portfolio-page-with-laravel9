...
var darkThemeSwitch = document.getElementById('dark_theme_switch');
...
document.addEventListener('scroll', function () {
  ...
  windowScrollAction = true;

  if (windowScrollAction) {
  ...
  switch (location.hash) {
    ...
    case '#about':
      if (htmlClassList.length) {
        ...
        logo.src = location.origin + "/img/logo_orange.png";
      }
    ...
    case '#portfolio':
      if (htmlClassList.length) {
        ...
        logo.src = location.origin + "/img/logo_blue.png";
      }
    ...
    case '#contact':
      if (htmlClassList.length) {
        ...
        logo.src = location.origin + "/img/logo_gold.png";
      }
